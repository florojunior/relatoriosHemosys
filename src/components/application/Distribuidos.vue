...
export default {
    ...
    data: () => ({
        ...
        headersExcel:{
            ...
            'Sequencial Separação':'SEQUENCIALSEPARACAO',
            'Data de Retorno':'DATAHORARETORNO',
            'Motivo Retorno':'DESCRICAOMOTIVORETORNO',
        },
        headers: [
            {
                text: 'Numero Bolsa',
    ...
    methods:{
        ...
        getAll(){
            this.loadingList = true;
            this.$http.get('/produtos-distribuido/',{
                params: {
        ...
        generatePDF(){
            var resultData = Object.assign([],this.resultData.map((element)=>{
                return [
                    ...
                    element.DATAHORARETORNO,
                    element.DESCRICAOMOTIVORETORNO,
                ]
            }));
            ...
            var customBody = [
                [
                    ...
                    {text: 'Motivo de Retorno', style: 'tableHeader'}
                ]
            ];
        ...
        dataExcel(){
            ...
            for (let index = 0; index < this.summarizer.length; index++) {
                ...
                if(index == 0){
                    ...
                    resultArrayExcel.push({
                        'NUMEROBOLSA': 'Quantidade de Produtos',
